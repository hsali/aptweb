...
var ServicesService = (function () {
    ...
    ServicesService.prototype.getByCategory = function (url, lookupCategory) {
    ...
    ServicesService.prototype.getByCategoryId = function (url, id, lookupCategory) {
        console.log(lookupCategory);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var params = new http_1.URLSearchParams();
        params.set('lookupCategory', lookupCategory);
    ...
    ServicesService.prototype.postServices = function (url, model) {
    ...
    ServicesService.prototype.putServices = function (url, id, model) {
        var body = JSON.stringify(model);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var params = new http_1.URLSearchParams();
    ...
    ServicesService.prototype.deleteServices = function (url, id) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var params = new http_1.URLSearchParams();
        params.set('serviceId', JSON.stringify(id));
        var options = new http_1.RequestOptions({ headers: headers, search: params });
    ...
    ServicesService.prototype.getServices = function (url, id) {
        console.log(id);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var params = new http_1.URLSearchParams();
    ...
    ServicesService.prototype.getServiceById = function (url, id) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var params = new http_1.URLSearchParams();
