...
var AppointmentComponent = (function () {
    function AppointmentComponent(fb, resourcesService, appointmentService, router) {
        this.fb = fb;
    ...
    AppointmentComponent.prototype.LoadResources = function () {
        var _this = this;
    ...
    AppointmentComponent.prototype.LoadWeeklyDays = function (date, isToday) {
        this.weeklyDays = [];
    ...
    AppointmentComponent.prototype.changeTabs = function (isdailyActive) {
        this.isDailyActive = isdailyActive;
        console.log(this.isDailyActive);
    };
    AppointmentComponent.prototype.onSubmit = function (formData) {
    };
    AppointmentComponent.prototype.FillAllTimes = function () {
        this.allTimes = [
...
AppointmentComponent = __decorate([
    ...
    __metadata("design:paramtypes", [forms_1.FormBuilder, resources_service_1.ResourcesService, appointment_service_1.AppointmentService, router_1.Router])
