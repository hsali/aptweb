...
export class UserAccountComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder, private userAccountService: UserAccountService, private router: Router) {
    ...
    onSubmit(formData: any) {
        ...
        if (formData.value['password'].trim() != formData.value['confirmPassword'].trim())
        {
            ...
            this.userAccountService.put(apiUrl, Number(sessionStorage.getItem("organizationId")), formData.value['firstName'], formData.value['lastName'], formData.value['password']).subscribe((data: any) => {
